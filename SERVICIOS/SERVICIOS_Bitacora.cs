...
namespace SERVICIOS
{
    ...
    //    SERVICIOS.SERVICIOS_Bitacora.RegistrarEvento(int/null/usuario.idquetengo,int (ID del evento), Request.UserHostAddress (ip));
        ...
        public static List<BE_EventoBitacoraVista> ObtenerEventos(BE_FiltroBitacora filtro)
        {
            return new DAL.DAL_Bitacora().ObtenerEventos(filtro);
        }

        public static List<string> ObtenerUsuarios() => new DAL.DAL_Bitacora().ObtenerUsuariosDistintos();
        public static List<string> ObtenerCriticidades() => new DAL.DAL_Bitacora().ObtenerCriticidadesDistintas();
        public static List<string> ObtenerModulos() => new DAL.DAL_Bitacora().ObtenerModulosDistintos();
