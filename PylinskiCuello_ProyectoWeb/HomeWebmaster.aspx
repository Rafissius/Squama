      ...
      <div class="cards-grid">
        ...
        <div class="card" style="border-color:rgba(184,107,242,.50)">
          ...
          <div class="card-body">
            ...
            <button type="button" class="card-btn" style="background:rgba(184,107,242,.85);color:#1f1205" onclick="location.href='GestionUsuarios.aspx'">Gestionar usuarios</button>
          </div>
        </div>
