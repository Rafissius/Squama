...
<div class="panel panel-red">
  ...
  <div class="panel-body">
    ...
    <div class="field">
      <label>Seleccionar archivo .bak *</label>
      <asp:FileUpload ID="fileUploadBAK" runat="server"
                      CssClass="input-file-aspnet"
                      accept=".bak" />
      <span class="field-hint">
        Seleccioná el archivo .bak desde tu computadora.
      </span>
    </div>
...
<script>
    ...
    document.getElementById('modalNombreArchivo').textContent = fileInput.files[0].name;
