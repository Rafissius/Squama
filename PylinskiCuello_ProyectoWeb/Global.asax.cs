...
namespace PylinskiCuello_ProyectoWeb
{
    public class Global : HttpApplication
    {
        ...
        private static void VerificacionPeriodicaCallback(object state)
        {
            ...
            try
            {
                // Verifica TODAS las entidades de _entidades (no una sola hardcodeada):
                // agregar/sacar una entidad de esa lista alcanza para que participe (o deje
                // de participar) también acá, sin tocar este archivo. Ya llama a
                // EstadoSistema.Bloquear internamente si encuentra inconsistencias.
