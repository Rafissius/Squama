...
<head>
  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .nav-hamburger { display: none; background: none; border: 1.5px solid rgba(217,173,38,.55);
      color: var(--gold); font-size: 18px; width: 38px; height: 38px; border-radius: 8px;
    ...
    .nav-dropdown { display: none; position: absolute; top: 68px; left: 0; right: 0;
      ...
      border-top: 1px solid rgba(217,173,38,.25); z-index: 200;
    ...
    .wip-icon {
      ...
      border: 2px solid rgba(217,173,38,.40);
    ...
    .wip-badge { display: inline-block; padding: 3px 18px; border-radius: 14px;
      border: 1px solid rgba(217,173,38,.50); background: rgba(217,173,38,.12);
      font-size: 10px; font-weight: 700; color: var(--gold); letter-spacing: 2px; }
    .wip-title { font-size: clamp(28px,5vw,56px); font-weight: 900; color: var(--gold);
      letter-spacing: 2px; line-height: 1;
      text-shadow: 0 0 40px rgba(217,173,38,.30), 0 4px 8px rgba(0,0,0,.8); }
    ...
    .wip-desc { font-family: 'IM Fell English', serif; font-style: italic;
      font-size: clamp(13px,1.3vw,17px); color: #f5e8bf;
    ...
    .wip-btn {
      padding: 12px 36px; border-radius: 10px; border: 1.5px solid rgba(217,173,38,.70);
