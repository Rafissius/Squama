  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .nav-avatar { width: 44px; height: 44px; border-radius: 50%;
      ...
      font-size: 18px; font-weight: 700; color: #1a0a00; border: 2px solid var(--c-role); flex-shrink: 0; }
    ...
    .nav-hamburger { display: none; background: none; border: 1.5px solid rgba(242,158,56,.55);
    ...
    .wip-icon { width: 90px; height: 90px; border-radius: 50%;
      ...
      border: 2px solid rgba(242,158,56,.40);
      display: flex; align-items: center; justify-content: center; font-size: 38px;
      box-shadow: 0 0 40px rgba(242,158,56,.15); }
    ...
    .wip-badge { display: inline-block; padding: 3px 18px; border-radius: 14px;
      border: 1px solid rgba(242,158,56,.50); background: rgba(242,158,56,.12);
